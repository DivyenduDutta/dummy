...
amass_splits = {
    ...
    #'train': ['CMU', 'MPI_Limits', 'TotalCapture', 'KIT', 'EKUT', 'TCD_handMocap', 'ACCAD'],
        ...
        for dataset_name in dataset_names:
            ...
            for sub in os.listdir(os.path.join(self.dataset_path, dataset_name)):
                ...
                for act in os.listdir(sub):
                    ...
                    #print('\nprinting the fps...')
                    #print(pose_all['mocap_framerate'].item()) #this is downsampled to 25 fps later on
                    ...
                    #print('\n')
                    #print(len(video_data['obs_pose']))
                    #print(len(video_data['obs_pose'][0]))
